...
if __name__ == "__main__":
    ...
    AI.LoadModel()
    VM = cv_module.Vision_Module(cameraPath2=1,q=UIQ,AI_module=AI,serial_port_address=None,voice_assistant_communication_queue=voice_assistant_communication_queue)
