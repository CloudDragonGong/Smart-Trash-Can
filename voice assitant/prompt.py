...
class ChatGPT():
    ...
    def get_response(self,text):
        ...
        self.prompt = f"""
            ...
            按照下面的格式回答：\
            “\
                - 有害垃圾有'''{self.information['harmful_garbage']}'''个\
                - 厨余垃圾有'''{self.information['kitchen_waste']}'''个\
                - 可回收垃圾有'''{self.information['recyclable_garbage']}'''个\
                - 其他垃圾有'''{self.information['other_garbage']}'''个\
            ”\
            同样，回答完这个后就不用回答了。\
...
if __name__ == '__main__':
    ...
    gpt = ChatGPT("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",information=information)
    text = '垃圾桶状况怎么样？'
