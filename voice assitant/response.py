...
def voice_reply(speech):
    ...
    gpt = prompt.ChatGPT("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",information=information)
    return gpt.get_response(speech)

def excute(voice_address):
    speech = stt.transform(voice_address)
    response = voice_reply(speech=speech)
    print(response)
...
if __name__ == "__main__":
    ...
    excute(voice_address=r'./recording.mp3')
